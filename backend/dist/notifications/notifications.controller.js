...
let NotificationsController = class NotificationsController {
    ...
    async getNotifications(userId, page = '1', limit = '20', unreadOnly) {
        const isUnreadOnly = unreadOnly === 'true';
        return this.notificationsService.getNotifications(userId, Number(page), Number(limit), isUnreadOnly);
    }
