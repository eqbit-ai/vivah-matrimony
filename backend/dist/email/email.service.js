...
let EmailService = EmailService_1 = class EmailService {
    ...
    async sendEmail(to, subject, html) {
        try {
            await this.transporter.sendMail({
                from: `"Vivah Matrimony" <${this.configService.get('SMTP_FROM') || 'noreply@vivahmatrimony.com'}>`,
                to,
                subject,
                html,
            });
    ...
    async sendMeetingInvitation(email, userName, partnerName, meetingDate, venue) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    async sendInterestNotification(email, userName, senderName) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p style="text-align: center;">
              <a href="${this.configService.get('FRONTEND_URL')}/dashboard/interests" class="button">View Interest</a>
            </p>
          </div>
          <div class="footer">
            <p>© 2024 Vivah Matrimony. All rights reserved.</p>
